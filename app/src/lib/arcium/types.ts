 ...
 * IDL can be found at `target/idl/confidential_policy.json`.
 */
export type ConfidentialPolicy = {
  "address": "EJphDwZdNmD972zPBjH3phvUga9Gamv21R1usMoQ4A6X",
  "metadata": {
    "name": "confidentialPolicy",
    "version": "0.1.0",
    "spec": "0.1.0",
    "description": "Confidential treasury policy evaluation via Arcium MXE — companion program to Black Budget"
  },
  "instructions": [
    {
      "name": "commitExecutedPayment",
      "docs": [
        ...
        },
        {
          ...
          "pda": {
            "seeds": [
              ...
              {
                "kind": "account",
                "path": "policy_acc.company_id",
                "account": "confidentialPolicyAccount"
              }
            ]
          }
        }
      ...
      "args": [
        ...
        {
          "name": "requesterEncryptionPubkey",
          "type": {
            "array": [
              "u8",
              32
    ...
    {
      "name": "commitExecutedPaymentCallback",
      "discriminator": [
        138,
        231,
        59,
              ...
              "generics": [
                {
                  ...
                  "type": {
                    "defined": {
                      "name": "commitExecutedPaymentOutput"
                    }
                  }
                }
              ]
    ...
    },
    {
      ...
      "args": [
        ...
        {
          "name": "encryptedAutoApproveLimit",
          "type": {
            "array": [
              "u8",
              32
        ...
        {
          "name": "encryptedDualApproveThreshold",
          "type": {
            "array": [
              "u8",
              32
    ...
    {
      "name": "initCompanyPolicyCallback",
      "discriminator": [
        227,
        55,
        255,
    ...
    {
      "name": "resetMonthlySpendCallback",
      "discriminator": [
        183,
        83,
        162,
    ...
    {
      "name": "updatePolicyLimitsCallback",
      "discriminator": [
        29,
        120,
        80,
  ...
  "accounts": [
    ...
    {
      "name": "confidentialPolicyAccount",
      "discriminator": [
        170,
        179,
        72,
